...
export default function ProfilePage({locale='en' as const}:{locale?:'en'|'ko'}) {
  ...
  return <PageShell locale={locale} path="/profile">
    ...
    <div className="profile-content">
      ...
      <section className="profile-media"><YoutubeEmbed/><div><h2>Podcast</h2><a className="text-link" href={site.socials.notion}>→ GOOD VIBE MUSIC PODCAST S1 E26</a></div></section>
    </div>
  </PageShell>;
}
