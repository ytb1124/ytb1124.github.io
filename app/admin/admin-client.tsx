...
export function AdminClient() {
  ...
  return <main className="admin-shell">
    ...
    {tab === 'production' && <div className="admin-panel">
      ...
      <div className="admin-title-row"><h2>Live Sound 활동</h2><button className="secondary" onClick={()=>updateDocument(paths.activities,(doc)=>doc.unshift({id:crypto.randomUUID(),title:'새 행사',englishTitle:'New Event',eventType:'Live Event Production',year:new Date().getFullYear().toString(),image:'',role:'Mixing Engineer'}))}>행사 추가</button></div>
